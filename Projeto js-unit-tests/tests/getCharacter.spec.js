...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    it ('verifica se retorna o objeto correto para Arya', () => {
    ...
    it ('verifica se retorna o objeto correto para o parâmetro Brienne', () => {
    ...
    it('verifica se retorna o objeto correto para Melissandre', () => {
    ...
    it('verifica se não é case Sensitive', () => {
      expect(getCharacter('case sensitive')).not.toBe('Arya', 'Brienne', 'Melissandre')
    })

    it('verifica se tiver nome que não esta na tabela, retorne undefined', () => {
      expect(getCharacter('name')).not.toBe('undefined')
    })
  });
