...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    expect(circle(1)).toEqual({radius:1, circumference:6.28, area: 3.14 });
   
    expect(circle(2)).toHaveProperty('area', 'circumference', 'radius');
    ...
    expect(circle(3)).toEqual({radius:3, circumference:18.84, area:28.259999999999998})
  });
});
